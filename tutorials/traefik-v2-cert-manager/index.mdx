...
4. Edit the YAML configuration file, change the service type to `LoadBalancer` instead of `ClusterIP`.
    <Lightbox src="scaleway-traefik_service_config.webp" alt="" />
5. Enter the name `traefik` for the application and type the `kube-system` namespace name.
    <Lightbox src="scaleway_application_name.webp" alt="" />
6. Click **Deploy an application** to deploy the Load Balancer on your cluster.
